...
<a href="https://pkg.go.dev/github.com/xberg-io/sdks/go"><img src="https://img.shields.io/badge/Go-pkg.go.dev-007ec6?logo=go&logoColor=white" alt="Go Reference"></a>
...
```sh
go get github.com/xberg-io/sdks/go
```
