...
_OcrQualityThresholds _$OcrQualityThresholdsFromJson(
    ...
    _OcrQualityThresholds(
      alnumWsRatioThreshold:
          (json['alnum_ws_ratio_threshold'] as num?)?.toDouble(),
      criticalFragmentedWordRatio:
          (json['critical_fragmented_word_ratio'] as num?)?.toDouble(),
      maxFragmentedWordRatio:
          (json['max_fragmented_word_ratio'] as num?)?.toDouble(),
      ...
      minConsecutiveRepeatRatio:
          (json['min_consecutive_repeat_ratio'] as num?)?.toDouble(),
      ...
      minNonWhitespacePerPage:
          (json['min_non_whitespace_per_page'] as num?)?.toDouble(),
      minTotalNonWhitespace:
          (json['min_total_non_whitespace'] as num?)?.toInt(),
      minWordsForAvgLengthCheck:
          (json['min_words_for_avg_length_check'] as num?)?.toInt(),
      minWordsForRepeatCheck:
          (json['min_words_for_repeat_check'] as num?)?.toInt(),
