...
@JsonKey(name: 'extraction_config') ExtractionConfig? get extractionConfig;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ExtractionOptions&&(identical(other.extractionConfig, extractionConfig) || other.extractionConfig == extractionConfig));
}
...
/// Create a copy of ExtractionOptions
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? extractionConfig = freezed,}) {
  return _then(_self.copyWith(
extractionConfig: freezed == extractionConfig ? _self.extractionConfig : extractionConfig // ignore: cast_nullable_to_non_nullable
as ExtractionConfig?,
  ));
}
/// Create a copy of ExtractionOptions
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'extraction_config')  ExtractionConfig? extractionConfig)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ExtractionOptions() when $default != null:
return $default(_that.extractionConfig);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'extraction_config')  ExtractionConfig? extractionConfig)  $default,) {final _that = this;
switch (_that) {
case _ExtractionOptions():
return $default(_that.extractionConfig);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'extraction_config')  ExtractionConfig? extractionConfig)?  $default,) {final _that = this;
switch (_that) {
case _ExtractionOptions() when $default != null:
return $default(_that.extractionConfig);case _:
  return null;
...
class _ExtractionOptions implements ExtractionOptions {
  const _ExtractionOptions({@JsonKey(name: 'extraction_config') this.extractionConfig});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ExtractionOptions&&(identical(other.extractionConfig, extractionConfig) || other.extractionConfig == extractionConfig));
}
...
/// Create a copy of ExtractionOptions
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? extractionConfig = freezed,}) {
