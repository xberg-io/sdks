...
mixin _$OcrConfig {
  ...
  OcrElementConfig? get elementConfig;
  ...
  $OcrConfigCopyWith<OcrConfig> get copyWith =>
      _$OcrConfigCopyWithImpl<OcrConfig>(this as OcrConfig, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.elementConfig, elementConfig) ||
                other.elementConfig == elementConfig) &&
            ...
            (identical(other.qualityThresholds, qualityThresholds) ||
                other.qualityThresholds == qualityThresholds) &&
            const DeepCollectionEquality()
                .equals(other.tesseractConfig, tesseractConfig) &&
            const DeepCollectionEquality().equals(other.vlmConfig, vlmConfig) &&
            (identical(other.vlmPrompt, vlmPrompt) ||
                other.vlmPrompt == vlmPrompt));
  }
...
abstract mixin class $OcrConfigCopyWith<$Res> {
  factory $OcrConfigCopyWith(OcrConfig value, $Res Function(OcrConfig) _then) =
      _$OcrConfigCopyWithImpl;
  @useResult
  $Res call(
      {@JsonKey(name: 'auto_rotate') bool? autoRotate,
      String? backend,
      @JsonKey(name: 'element_config') OcrElementConfig? elementConfig,
      String? language,
...
/// @nodoc
class _$OcrConfigCopyWithImpl<$Res> implements $OcrConfigCopyWith<$Res> {
  ...
  @override
  $Res call({
    Object? autoRotate = freezed,
    Object? backend = freezed,
    Object? elementConfig = freezed,
    Object? language = freezed,
    Object? outputFormat = freezed,
    Object? pipeline = freezed,
    Object? qualityThresholds = freezed,
    Object? tesseractConfig = freezed,
    Object? vlmConfig = freezed,
    Object? vlmPrompt = freezed,
  }) {
    return _then(_self.copyWith(
      autoRotate: freezed == autoRotate
          ? _self.autoRotate
      ...
      backend: freezed == backend
          ...
          : backend // ignore: cast_nullable_to_non_nullable
              as String?,
      elementConfig: freezed == elementConfig
          ? _self.elementConfig
          : elementConfig // ignore: cast_nullable_to_non_nullable
              as OcrElementConfig?,
      ...
      pipeline: freezed == pipeline
          ...
          : pipeline // ignore: cast_nullable_to_non_nullable
              as OcrPipelineConfig?,
      qualityThresholds: freezed == qualityThresholds
          ? _self.qualityThresholds
          : qualityThresholds // ignore: cast_nullable_to_non_nullable
              as OcrQualityThresholds?,
      ...
      vlmConfig: freezed == vlmConfig
          ...
          : vlmConfig // ignore: cast_nullable_to_non_nullable
              as dynamic,
      vlmPrompt: freezed == vlmPrompt
          ? _self.vlmPrompt
          : vlmPrompt // ignore: cast_nullable_to_non_nullable
              as String?,
    ));
  }
  ...
  $OcrQualityThresholdsCopyWith<$Res>? get qualityThresholds {
    ...
    return $OcrQualityThresholdsCopyWith<$Res>(_self.qualityThresholds!,
        (value) {
...
extension OcrConfigPatterns on OcrConfig {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_OcrConfig value)? $default, {
    ...
    switch (_that) {
      case _OcrConfig() when $default != null:
        return $default(
            ...
            _that.outputFormat,
            _that.pipeline,
            _that.qualityThresholds,
            _that.tesseractConfig,
            _that.vlmConfig,
            _that.vlmPrompt);
      case _:
        return orElse();
...
class _OcrConfig implements OcrConfig {
  const _OcrConfig(
      {@JsonKey(name: 'auto_rotate') this.autoRotate,
      this.backend,
      @JsonKey(name: 'element_config') this.elementConfig,
      this.language,
      @JsonKey(name: 'output_format') this.outputFormat,
      this.pipeline,
      @JsonKey(name: 'quality_thresholds') this.qualityThresholds,
      @JsonKey(name: 'tesseract_config') this.tesseractConfig,
      @JsonKey(name: 'vlm_config') this.vlmConfig,
      @JsonKey(name: 'vlm_prompt') this.vlmPrompt});
  factory _OcrConfig.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$OcrConfigCopyWith<_OcrConfig> get copyWith =>
      __$OcrConfigCopyWithImpl<_OcrConfig>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$OcrConfigToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$OcrConfigCopyWith<$Res>
    implements $OcrConfigCopyWith<$Res> {
  factory _$OcrConfigCopyWith(
          _OcrConfig value, $Res Function(_OcrConfig) _then) =
      __$OcrConfigCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'auto_rotate') bool? autoRotate,
...
/// @nodoc
class __$OcrConfigCopyWithImpl<$Res> implements _$OcrConfigCopyWith<$Res> {
