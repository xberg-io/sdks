...
mixin _$LanguageDetectionConfig {
  ...
  $LanguageDetectionConfigCopyWith<LanguageDetectionConfig> get copyWith =>
      _$LanguageDetectionConfigCopyWithImpl<LanguageDetectionConfig>(
          this as LanguageDetectionConfig, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.detectMultiple, detectMultiple) ||
                other.detectMultiple == detectMultiple) &&
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, detectMultiple, enabled, minConfidence);
...
abstract mixin class $LanguageDetectionConfigCopyWith<$Res> {
  factory $LanguageDetectionConfigCopyWith(LanguageDetectionConfig value,
          $Res Function(LanguageDetectionConfig) _then) =
      _$LanguageDetectionConfigCopyWithImpl;
  @useResult
  $Res call(
...
class _$LanguageDetectionConfigCopyWithImpl<$Res>
  ...
  @override
  $Res call({
    Object? detectMultiple = freezed,
    Object? enabled = freezed,
    Object? minConfidence = freezed,
  }) {
    return _then(_self.copyWith(
      detectMultiple: freezed == detectMultiple
          ? _self.detectMultiple
          : detectMultiple // ignore: cast_nullable_to_non_nullable
              as bool?,
...
extension LanguageDetectionConfigPatterns on LanguageDetectionConfig {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_LanguageDetectionConfig value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _LanguageDetectionConfig() when $default != null:
        return $default(
            _that.detectMultiple, _that.enabled, _that.minConfidence);
      case _:
        return orElse();
    }
  }
...
class _LanguageDetectionConfig implements LanguageDetectionConfig {
  const _LanguageDetectionConfig(
      {@JsonKey(name: 'detect_multiple') this.detectMultiple,
      this.enabled,
      @JsonKey(name: 'min_confidence') this.minConfidence});
  factory _LanguageDetectionConfig.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$LanguageDetectionConfigCopyWith<_LanguageDetectionConfig> get copyWith =>
      __$LanguageDetectionConfigCopyWithImpl<_LanguageDetectionConfig>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$LanguageDetectionConfigToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _LanguageDetectionConfig &&
            (identical(other.detectMultiple, detectMultiple) ||
                other.detectMultiple == detectMultiple) &&
            (identical(other.enabled, enabled) || other.enabled == enabled) &&
            (identical(other.minConfidence, minConfidence) ||
...
/// @nodoc
abstract mixin class _$LanguageDetectionConfigCopyWith<$Res>
    implements $LanguageDetectionConfigCopyWith<$Res> {
  factory _$LanguageDetectionConfigCopyWith(_LanguageDetectionConfig value,
          $Res Function(_LanguageDetectionConfig) _then) =
      __$LanguageDetectionConfigCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'detect_multiple') bool? detectMultiple,
