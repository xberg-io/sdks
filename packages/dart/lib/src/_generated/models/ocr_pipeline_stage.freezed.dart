...
$OcrPipelineStageCopyWith<OcrPipelineStage> get copyWith => _$OcrPipelineStageCopyWithImpl<OcrPipelineStage>(this as OcrPipelineStage, _$identity);
...
/// Create a copy of OcrPipelineStage
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? backend = null,Object? language = freezed,Object? priority = freezed,Object? tesseractConfig = freezed,Object? vlmConfig = freezed,}) {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _OcrPipelineStage value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _OcrPipelineStage value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _OcrPipelineStage value)?  $default,){
final _that = this;
switch (_that) {
case _OcrPipelineStage() when $default != null:
return $default(_that);case _:
...
class _OcrPipelineStage implements OcrPipelineStage {
  const _OcrPipelineStage({required this.backend, this.language, this.priority, @JsonKey(name: 'tesseract_config') this.tesseractConfig, @JsonKey(name: 'vlm_config') this.vlmConfig});
  factory _OcrPipelineStage.fromJson(Map<String, dynamic> json) => _$OcrPipelineStageFromJson(json);
...
@pragma('vm:prefer-inline')
_$OcrPipelineStageCopyWith<_OcrPipelineStage> get copyWith => __$OcrPipelineStageCopyWithImpl<_OcrPipelineStage>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$OcrPipelineStageToJson(this, );
}
...
/// @nodoc
abstract mixin class _$OcrPipelineStageCopyWith<$Res> implements $OcrPipelineStageCopyWith<$Res> {
...
/// Create a copy of OcrPipelineStage
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? backend = null,Object? language = freezed,Object? priority = freezed,Object? tesseractConfig = freezed,Object? vlmConfig = freezed,}) {
