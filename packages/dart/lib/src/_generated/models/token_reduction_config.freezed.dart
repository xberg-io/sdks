...
mixin _$TokenReductionConfig {
  ...
  bool? get preserveImportantWords;

  /// Create a copy of TokenReductionConfig
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $TokenReductionConfigCopyWith<TokenReductionConfig> get copyWith =>
      _$TokenReductionConfigCopyWithImpl<TokenReductionConfig>(
          this as TokenReductionConfig, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.preserveImportantWords, preserveImportantWords) ||
                other.preserveImportantWords == preserveImportantWords));
  }
...
abstract mixin class $TokenReductionConfigCopyWith<$Res> {
  factory $TokenReductionConfigCopyWith(TokenReductionConfig value,
          $Res Function(TokenReductionConfig) _then) =
      _$TokenReductionConfigCopyWithImpl;
  @useResult
  $Res call(
      {String? mode,
...
class _$TokenReductionConfigCopyWithImpl<$Res>
  ...
  $Res call({
    Object? mode = freezed,
    Object? preserveImportantWords = freezed,
  }) {
    return _then(_self.copyWith(
      mode: freezed == mode
          ...
          : mode // ignore: cast_nullable_to_non_nullable
              as String?,
      preserveImportantWords: freezed == preserveImportantWords
          ? _self.preserveImportantWords
          : preserveImportantWords // ignore: cast_nullable_to_non_nullable
              as bool?,
    ));
  }
}
...
extension TokenReductionConfigPatterns on TokenReductionConfig {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_TokenReductionConfig value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _TokenReductionConfig() when $default != null:
        return $default(_that.mode, _that.preserveImportantWords);
      case _:
        return orElse();
    }
  }
...
class _TokenReductionConfig implements TokenReductionConfig {
  const _TokenReductionConfig(
      {this.mode,
      @JsonKey(name: 'preserve_important_words') this.preserveImportantWords});
  factory _TokenReductionConfig.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$TokenReductionConfigCopyWith<_TokenReductionConfig> get copyWith =>
      __$TokenReductionConfigCopyWithImpl<_TokenReductionConfig>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$TokenReductionConfigToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _TokenReductionConfig &&
            (identical(other.mode, mode) || other.mode == mode) &&
            (identical(other.preserveImportantWords, preserveImportantWords) ||
                other.preserveImportantWords == preserveImportantWords));
  }
...
/// @nodoc
abstract mixin class _$TokenReductionConfigCopyWith<$Res>
    implements $TokenReductionConfigCopyWith<$Res> {
  factory _$TokenReductionConfigCopyWith(_TokenReductionConfig value,
          $Res Function(_TokenReductionConfig) _then) =
      __$TokenReductionConfigCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? mode,
