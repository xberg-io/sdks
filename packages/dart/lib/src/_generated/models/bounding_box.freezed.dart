...
/// Left x-coordinate
 double get x0;/// Right x-coordinate
 double get x1;/// Bottom y-coordinate
 double get y0;/// Top y-coordinate
 double get y1;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BoundingBox&&(identical(other.x0, x0) || other.x0 == x0)&&(identical(other.x1, x1) || other.x1 == x1)&&(identical(other.y0, y0) || other.y0 == y0)&&(identical(other.y1, y1) || other.y1 == y1));
}
...
/// Create a copy of BoundingBox
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? x0 = null,Object? x1 = null,Object? y0 = null,Object? y1 = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( double x0,  double x1,  double y0,  double y1)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BoundingBox() when $default != null:
return $default(_that.x0,_that.x1,_that.y0,_that.y1);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( double x0,  double x1,  double y0,  double y1)  $default,) {final _that = this;
switch (_that) {
case _BoundingBox():
return $default(_that.x0,_that.x1,_that.y0,_that.y1);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( double x0,  double x1,  double y0,  double y1)?  $default,) {final _that = this;
switch (_that) {
case _BoundingBox() when $default != null:
return $default(_that.x0,_that.x1,_that.y0,_that.y1);case _:
  return null;
...
class _BoundingBox implements BoundingBox {
  const _BoundingBox({required this.x0, required this.x1, required this.y0, required this.y1});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _BoundingBox&&(identical(other.x0, x0) || other.x0 == x0)&&(identical(other.x1, x1) || other.x1 == x1)&&(identical(other.y0, y0) || other.y0 == y0)&&(identical(other.y1, y1) || other.y1 == y1));
}
...
/// Create a copy of BoundingBox
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? x0 = null,Object? x1 = null,Object? y0 = null,Object? y1 = null,}) {
