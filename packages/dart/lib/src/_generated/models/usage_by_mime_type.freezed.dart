...
mixin _$UsageByMimeType {
  ...
  $UsageByMimeTypeCopyWith<UsageByMimeType> get copyWith =>
      _$UsageByMimeTypeCopyWithImpl<UsageByMimeType>(
          this as UsageByMimeType, _$identity);
...
abstract mixin class $UsageByMimeTypeCopyWith<$Res> {
  factory $UsageByMimeTypeCopyWith(
          UsageByMimeType value, $Res Function(UsageByMimeType) _then) =
      _$UsageByMimeTypeCopyWithImpl;
  @useResult
  $Res call({int documents, int failed, int pages});
}
...
extension UsageByMimeTypePatterns on UsageByMimeType {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_UsageByMimeType value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(int documents, int failed, int pages)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _UsageByMimeType() when $default != null:
        return $default(_that.documents, _that.failed, _that.pages);
      case _:
        return orElse();
    }
  }
...
class _UsageByMimeType implements UsageByMimeType {
  const _UsageByMimeType(
      {required this.documents, required this.failed, required this.pages});
  factory _UsageByMimeType.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$UsageByMimeTypeCopyWith<_UsageByMimeType> get copyWith =>
      __$UsageByMimeTypeCopyWithImpl<_UsageByMimeType>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$UsageByMimeTypeToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$UsageByMimeTypeCopyWith<$Res>
    implements $UsageByMimeTypeCopyWith<$Res> {
  factory _$UsageByMimeTypeCopyWith(
          _UsageByMimeType value, $Res Function(_UsageByMimeType) _then) =
      __$UsageByMimeTypeCopyWithImpl;
  @override
  @useResult
  $Res call({int documents, int failed, int pages});
}
