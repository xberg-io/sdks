...
@JsonKey(name: 'cache_namespace') String? get cacheNamespace;/// Per-request cache TTL override in seconds
@JsonKey(name: 'cache_ttl_secs') int? get cacheTtlSecs;/// Text chunking configuration
 ChunkingConfig? get chunking;/// Content filtering (headers, footers, watermarks)
@JsonKey(name: 'content_filter') ContentFilterConfig? get contentFilter;/// Disable OCR entirely
@JsonKey(name: 'disable_ocr') bool? get disableOcr;/// Enable quality post-processing
@JsonKey(name: 'enable_quality_processing') bool? get enableQualityProcessing;/// Per-file extraction timeout in seconds
@JsonKey(name: 'extraction_timeout_secs') int? get extractionTimeoutSecs;/// Force OCR on all pages (bypass native text extraction)
@JsonKey(name: 'force_ocr') bool? get forceOcr;/// Force OCR on specific pages (1-indexed)
...
$ExtractionConfigCopyWith<ExtractionConfig> get copyWith => _$ExtractionConfigCopyWithImpl<ExtractionConfig>(this as ExtractionConfig, _$identity);
...
as int?,chunking: freezed == chunking ? _self.chunking : chunking // ignore: cast_nullable_to_non_nullable
...
as List<int>?,htmlOptions: freezed == htmlOptions ? _self.htmlOptions : htmlOptions // ignore: cast_nullable_to_non_nullable
...
as PageConfig?,pdfOptions: freezed == pdfOptions ? _self.pdfOptions : pdfOptions // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ExtractionConfig value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ExtractionConfig value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ExtractionConfig value)?  $default,){
final _that = this;
switch (_that) {
case _ExtractionConfig() when $default != null:
return $default(_that);case _:
...
/// Cache namespace for tenant isolation
@override@JsonKey(name: 'cache_namespace') final  String? cacheNamespace;
/// Per-request cache TTL override in seconds
@override@JsonKey(name: 'cache_ttl_secs') final  int? cacheTtlSecs;
...
@override@JsonKey(name: 'html_options') final  dynamic htmlOptions;
...
@override final  LayoutDetectionConfig? layout;
...
@override@JsonKey(name: 'pdf_options') final  PdfConfig? pdfOptions;
...
@pragma('vm:prefer-inline')
_$ExtractionConfigCopyWith<_ExtractionConfig> get copyWith => __$ExtractionConfigCopyWithImpl<_ExtractionConfig>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ExtractionConfigToJson(this, );
}
...
/// @nodoc
abstract mixin class _$ExtractionConfigCopyWith<$Res> implements $ExtractionConfigCopyWith<$Res> {
